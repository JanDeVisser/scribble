...
#define BINARY_OPERATORS(S)                                             \
    ...
    S(ASSIGN, false, 14, TK_SYMBOL, '=')                                \
    S(ASSIGN_BITWISE_AND, false, 14, TK_KEYWORD, KW_ASSIGN_BITWISE_AND) \
    S(ASSIGN_BITWISE_OR, false, 14, TK_KEYWORD, KW_ASSIGN_BITWISE_OR)   \
    S(ASSIGN_BITWISE_XOR, false, 14, TK_KEYWORD, KW_ASSIGN_BITWISE_XOR) \
    S(ASSIGN_SHIFT_LEFT, false, 14, TK_KEYWORD, KW_ASSIGN_SHIFT_LEFT)   \
    S(ASSIGN_SHIFT_RIGHT, false, 14, TK_KEYWORD, KW_ASSIGN_SHIFT_RIGHT) \
    S(BINARY_DECREMENT, false, 14, TK_KEYWORD, KW_BINARY_DECREMENT)     \
    S(BINARY_INCREMENT, false, 14, TK_KEYWORD, KW_BINARY_INCREMENT)     \
    S(ASSIGN_MULTIPLY, false, 14, TK_KEYWORD, KW_ASSIGN_MULTIPLY)       \
    S(ASSIGN_DIVIDE, false, 14, TK_KEYWORD, KW_ASSIGN_DIVIDE)           \
    S(ASSIGN_MODULO, false, 14, TK_KEYWORD, KW_ASSIGN_MODULO)
